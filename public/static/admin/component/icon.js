    ...
    IconPicker.prototype.render = function(options) {
        ...
        var a = {
            ...
            createSelect: function() {
                ...
                var selectHtml = '<div class="layui-iconpicker layui-unselect layui-form-select layui-inline" id="' + ICON_BODY + '">' +
        ...
        if (url !== undefined){
            $.post({
                ...
                success:function (res) {
                    urlData = res.data === undefined?[]:res.data;
                    a.init();
                }
            })
        }
